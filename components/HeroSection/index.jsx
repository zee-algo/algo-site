      ...
      <section class="bg-customOffWhiteBG">
        <div class="mx-auto max-w-screen-2xl text-center py-8 px-4 lg:py-16 lg:px-12">
          <div className="hero-heading">
            ...
            <p class="mb-8 text-lg font-normal text-secondryColor lg:text-3xl sm:px-16 xl:px-48 ">
              We are <span class="text-primaryColor">Algo</span> , a Creative
              Web Agency
            </p>
          </div>

          <div className="center-btn-img-section py-6 md:py-8 lg:py-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 md:justify-center">
              <div className="flex flex-row justify-center md:justify-center lg:justify-start space-x-12">
                <div className="">
                  <Image src="/SliderImg3.png" width={60} height={60} alt="" />
                </div>

                <div className="-mt-9">
                  <Image src="/SliderImg3.png" width={80} height={80} alt="" />
                </div>
                <div className="">
                  <Image src="/SliderImg3.png" width={90} height={90} alt="" />
                </div>
              </div>
              ...
              <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                <a
                  href="#"
                  class="inline-flex justify-center items-center py-3 px-5 capitalize text-base font-extrabold text-center text-white rounded-lg bg-primaryColor"
                >
                  Start a Project
                </a>
                <a
                  href="#"
                  class="inline-flex justify-center items-center py-3 px-5 capitalize text-base font-medium text-center text-primaryColor rounded-lg border border-primaryColor "
                >
                  How We Work
                </a>
              </div>

              <div className="flex flex-row justify-center md:justify-center lg:justify-end space-x-12">
                <div className="">
                  <Image src="/SliderImg3.png" width={90} height={90} alt="" />
                </div>
          ...
          <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-26">
            <div class="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
              <a href="#" class="mr-4 mb-5 lg:mb-0 hover:text-gray-800 ">
                {/* <svg
                  class="h-8"
                  viewBox="0 0 132 29"
                  fill="none"
                ...
                <Image src="/SliderImgOne.png" width={170} height={100} alt=""/>
              </a>
              <a href="#" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800 ">
              <Image src="/SliderImgTwo.png" width={170} height={100} alt=""/>
              </a>
              <a href="#" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800 ">
              <Image src="/SliderImgThree.png" width={170} height={100} alt=""/>
              </a>
              <a href="#" class="mr-5 mb-5 lg:mb-0 hover:text-gray-800 ">
              <Image src="/SliderImgFour.png" width={170} height={100} alt=""/>
              </a>
            </div>
          </div>
        </div>
